  ...
  children: [
    {
      id: "ch-1",
      title: "1. 招标公告",
      summary: "本招标项目为高性能计算集群采购项目，招标人为未来科技有限公司。",
      children: []
    },
    {
      id: "ch-2",
      title: "2. 投标人须知",
      summary: "投标人必须具备独立法人资格，注册资金不低于5000万元。",
      children: [
        {
          id: "ch-2-1",
          title: "2.1 投标文件的构成",
          summary: "投标文件应包括：投标函、开标一览表、技术偏离表等。",
          children: []
        },
        {
          id: "ch-2-2",
          title: "2.2 投标保证金",
          summary: "投标保证金金额为人民币10万元整，支付方式为银行转账。",
          children: []
        }
      ]
    },
    {
      id: "ch-3",
      title: "3. 技术规格书",
      summary: "本项目要求提供一套完整的高性能计算(HPC)集群系统。",
      children: [
        {
          id: "ch-3-1",
          title: "3.1 总体架构要求",
          summary: "系统应采用CPU+GPU异构计算架构，支持由Kubernetes进行容器化管理。",
          children: []
        },
        {
          id: "ch-3-2",
          title: "3.2 计算节点配置",
          summary: "每个计算节点应配置：双路 AMD EPYC 9004系列处理器，单颗核心数>=64核；内存>=512GB DDR5。",
          children: [
             {
                id: "ch-3-2-1",
                title: "3.2.1 处理器详细参数",
                summary: "主频>=2.4GHz，三级缓存>=256MB。",
                children: []
             }
          ]
        },
        {
          id: "ch-3-3",
          title: "3.3 存储系统",
          summary: "需配置并行文件系统，可用容量>=500TB，聚合读写带宽>=20GB/s。",
          children: []
        }
      ]
    },
    {
      id: "ch-4",
      title: "4. 商务及服务要求",
      summary: "商务条款及售后服务相关规定。",
      children: [
        {
          id: "ch-4-1",
          title: "4.1 交付周期",
          summary: "合同签订后 30 个自然日内完成设备到货、安装及调试。",
          children: []
        },
        {
          id: "ch-4-2",
          title: "4.2 质保期",
          summary: "提供原厂质保服务，质保期为验收合格之日起 5 年。质保期内提供7x24小时上门服务。",
          children: []
        }
      ]
    }
